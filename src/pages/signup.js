...
export default function SignUp() {
    ...
    const handleSignUp = () => {
        ...
        } else if (formData.name && formData.name !== '' && formData.email && formData.email !== '' && formData.password && formData.password !== '' && formData.cnfPassword && formData.cnfPassword !== '') {
            setMessage({ msg: 'Password doesn`t matched', type: 'error' });
        } else {
                ...
                <div className="flex flex-wrap items-center min-h-96">
                    ...
                    <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                        <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                            ...
                            <div className="mb-5">
                                <button className="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90" onClick={handleSignUp}>
                                    Create account
                                </button>
                            </div>
