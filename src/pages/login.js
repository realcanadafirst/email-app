'use client'
import GuestLayout from "@ft/ui-components/Layouts/GuestLayout";
                    ...
                    <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                        <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                            <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                                Sign In to Feature toggle
                            </h2>
                            <div className="mb-5">
                                <button className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50 border border-meta-3 py-4 px-10 text-center font-medium text-meta-3 hover:bg-opacity-90" onClick={() => { handleLogin('redirect') }}>
                                    Sign in
                                </button>
                            </div>
                        </div>
