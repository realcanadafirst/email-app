                            ...
                            <tr>
                                ...
                                <th className="w-1/4 min-w-[200px] px-5">
                                    <div className="mb-10 text-left">
                                        ...
                                        <h4 className="mb-4">
                                            <span className="text-[28px] font-bold text-black dark:text-white lg:text-[32px]">$59</span>
                                ...
                                <th className="w-1/4 min-w-[200px] px-5">
                                    <div className="mb-10 text-left">
                                        ...
                                        <h4 className="mb-4">
                                            <span className="text-[28px] font-bold text-black dark:text-white lg:text-[32px]">$99</span>
                                            <span className="font-medium">Per Month</span>
                                        </h4>
                                ...
                                <th className="w-1/4 min-w-[200px] px-5">
                                    <div className="mb-10 text-left">
                                        ...
                                        <h4 className="mb-4">
                                            <span className="text-[28px] font-bold text-black dark:text-white lg:text-[32px]">$149</span>
                                            <span className="font-medium">Per Month</span>
                                        </h4>
                                        <p className="mb-6 font-medium">
