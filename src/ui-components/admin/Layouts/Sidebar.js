                ...
                <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
                    <div>
                        ...
                        <ul className="mb-6 flex flex-col gap-1.5">
                            <SidebarLinkGroup
                                activeCondition={
                                    pathname === "/" || pathname.includes("dashboard") || pathname.includes("subscription") || pathname.includes("users")
                                }
                            >
                                {(handleClick, open) => {
                                    return (
                                ...
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <Link
                                                href="#"
                                                className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname.includes("email")) &&
                                                    "bg-graydark dark:bg-meta-4"
                                                    }`}
                                                onClick={(e) => {
                                                    e.preventDefault();
                                            ...
                                            >
                                                <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                                    <li>
                                                        <Link
                                                            href="/email/list"
                                                            className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/email/list" && "text-white"
                                                                }`}
                                                        >
                                                            List
                                                        </Link>
                                                    ...
                                                    <li>
                                                        <Link
                                                            href="/email/contact"
                                                            className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/email/contact" && "text-white"
                                                                }`}
                                                        >
                                                            Contact List
                                                        </Link>
                                                    ...
                                                    <li>
                                                        <Link
                                                            href="/email/send"
                                                            className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/email/send" && "text-white"
                                                                }`}
                                                        >
                                                            Send email
                                                        </Link>
